...
let BlogModule = class BlogModule {
    configure(consumer) {
        consumer.apply(authentication_middleware_1.AuthenticationMiddleware).forRoutes({ method: common_1.RequestMethod.POST, path: '/blog/post' }, { method: common_1.RequestMethod.PUT, path: '/blog/edit' }, { method: common_1.RequestMethod.DELETE, path: '/blog/delete' });
    }
};
